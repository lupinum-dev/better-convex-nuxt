...
/**
 * Test page for optimistic updates
 *
...
<template>
  <div data-testid="optimistic-page" class="test-page">
    <h1>Optimistic Updates: Notes</h1>
    <p>Compare behavior with and without optimistic updates.</p>

    <NuxtLink to="/test-optimistic/hub" class="back-link"> Back to Hub </NuxtLink>
