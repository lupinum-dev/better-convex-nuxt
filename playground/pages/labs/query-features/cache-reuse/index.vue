...
async function seedDemoNotes() {
  const samples = [
    ...
    },
    {
      ...
      content:
        'Use useNuxtData with getQueryKey to synchronously read list query results and seed a detail page default. Combine that with lazy: true so route navigation does not block while the full query fetches in the background.',
    },
    {
