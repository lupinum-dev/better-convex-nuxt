 ...
 * - Client nav: Blocked until data loads, then has data immediately
 * - Uses await so both SSR and CSR wait for data
 */
...
<template>
  <div data-testid="server-true-lazy-false-page" class="test-page">
    ...
    <p class="description">SSR fetches data, client navigation blocked until data loads</p>
