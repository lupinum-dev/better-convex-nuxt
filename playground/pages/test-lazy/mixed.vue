...
/**
 * Test page for mixed lazy settings
 *
 * Query A: lazy: true
 * Query B: lazy: false (blocking)
 * Query C: lazy: true
 *
 * Expected behavior:
 * - The lazy:false query (B) should block navigation
 * - When page renders, all queries should have data ready
 *   (because one blocking query blocks the entire page)
 */
...
// Query B - lazy: false (blocking)
const queryB = useConvexQuery(api.notes.list, {}, { lazy: false })
...
<template>
  <div data-testid="mixed-page" class="test-page">
    <h1>Mixed Lazy Settings</h1>
    ...
    <div class="queries-grid">
      ...
      <!-- Query B: lazy: false (blocking) -->
      <section class="query-section blocking">
        <h2>Query B (lazy: false) <span class="badge">BLOCKING</span></h2>
        <div class="state-subsection">
          <h3>Initial State</h3>
          <div class="state-grid">
            <div class="state-item">
