...
/**
 * Test page for lazy: true behavior
 *
 * Expected behavior:
 * - Navigation is instant (doesn't block)
 * - initial-pending = true
 * - initial-has-data = false
 * - Eventually data loads and current-* values update
 */
...
<template>
  <div data-testid="lazy-true-page" class="test-page">
    <h1>lazy: true (Single Query)</h1>
