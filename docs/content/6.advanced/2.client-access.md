...
Access the raw `ConvexClient` instance for advanced use cases that aren't covered by the higher-level composables.
...
- [Fetching Data](/data-fetching/queries) - SSR-compatible queries with real-time updates
- [Mutations](/mutations/mutations) - Mutations with optimistic updates
