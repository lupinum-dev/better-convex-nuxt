...
Instant UI feedback before the server confirms changes. If the mutation fails, changes are automatically rolled back.
...
- [Mutations](/mutations/mutations) - Mutation composable
