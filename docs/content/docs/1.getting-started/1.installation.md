...
::callout{icon="i-lucide-info" to="https://docs.convex.dev/quickstart/nuxt" target="\_blank"}
New to Convex? Follow the [Convex quickstart guide](https://docs.convex.dev/quickstart/nuxt) to set up your backend first.
::
...
### Recommended Setup (Shared `.env.local`)
...
- `https://your-project.convex.cloud` → `https://your-project.convex.site`
...
Find your URL in the [Convex dashboard](https://dashboard.convex.dev) under Settings.
