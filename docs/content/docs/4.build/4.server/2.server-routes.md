...
Do not serialize raw upstream errors, request objects, or credentials. `ConvexCallError` deliberately
does not retain the raw upstream cause. Map expected domain errors to a public response contract and log
