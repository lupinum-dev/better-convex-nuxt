...
If your app runs entirely in the root Convex environment (no components), you do not need bridges — `app.query(...)` and `app.mutation(...)` handle identity automatically.
