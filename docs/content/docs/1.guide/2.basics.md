...
::tip
You can combine options! Use `useConvexQueryLazy` to render on the server for the first visit, but show a loading spinner immediately on client-side navigation instead of blocking.
::
