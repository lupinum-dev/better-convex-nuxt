...
Use the `useConvexQuery` composable to subscribe to your data. It will update in real-time!
Also when you hover over the `tasks` in tempalte, you should all types.
