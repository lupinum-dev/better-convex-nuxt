...
Let's build a simple todo list with real-time updates. You'll learn the core patterns for queries and mutations.
...
| Concept           | Description                                         |
| ----------------- | --------------------------------------------------- |
| **Queries** asdas | Read data, automatically subscribe to changes       |
...
::card-group
::card{title="Fetching Data" to="/data-fetching/queries" icon="i-lucide-database"}
Deep dive into query patterns
::
::card{title="Mutations" to="/mutations/mutations" icon="i-lucide-pen-tool"}
...
::
::card{title="SSR & Hydration" to="/server-side/ssr-hydration" icon="i-lucide-server"}
