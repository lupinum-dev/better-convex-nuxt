...
Build a complete role-based access control (RBAC) system with ownership rules. This guide walks you through creating a permission system where:
...
- [Authentication set up](/auth-security/authentication)
...
::card-group
::card{title="Permissions Reference" to="/auth-security/permissions" icon="i-lucide-shield"}
