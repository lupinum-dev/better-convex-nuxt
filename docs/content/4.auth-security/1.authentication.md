...
Access authentication state with SSR support. Pre-populated during server rendering for zero loading flash.
...
- [Permissions](/auth-security/permissions) - Role-based access control
- [SSR & Hydration](/server-side/ssr-hydration) - Skeleton loaders for auth content
