...
The glossary lives at [`2.concepts/2.glossary.md`](content/docs/2.concepts/2.glossary.md). Every Trellis-specific term — *principal, actor, guard, check, operation, tenant, projection, App Runtime, Nuxt Runtime, Agent Runtime, transport, business layer* — has a stable anchor there.
