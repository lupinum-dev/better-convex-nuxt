# MCP Agent Starter Guardrails

- MCP tools are transport adapters only.
- Do not duplicate product mutations for MCP.
- Convex must re-check service actor access on every function call.
