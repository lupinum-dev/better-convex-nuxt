...
import { canReadLesson, hasRole } from './auth/checks'

const joinRoleValidator = v.union(v.literal('admin'), v.literal('instructor'), v.literal('student'))
...
export const getPermissionContext = query({
  ...
  handler: async (ctx) => {
    ...
    return {
      ...
      can: {
        'lesson.read': can(actor, canReadLesson),
        'course.seed': can(actor, hasRole('owner', 'admin', 'instructor')),
      },
    }
  },
})
