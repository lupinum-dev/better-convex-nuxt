...
describe('package subpath exports', () => {
  it('publishes the current package subpaths', () => {
    ...
    expect(packageJson.exports).toHaveProperty('./bridge')
    ...
    expect(packageJson.typesVersions['*']).toHaveProperty('bridge')
  ...
  it('maps runtime subpath imports to built ESM entry files', () => {
    ...
    expect(packageJson.exports['./bridge'].import).toBe('./dist/runtime/bridge/index.mjs')
