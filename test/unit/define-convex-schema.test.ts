...
describe('defineConvexSchema', () => {
  ...
  // -----------------------------------------------------------------------
  describe('.toMcpInput', () => {
    it('returns a Zod schema shape (requires zod installed)', async () => {
      const shape = await schema.toMcpInput()
    ...
    it('generated Zod fields have correct types', async () => {
      const shape = await schema.toMcpInput()
      // Zod schemas have _def.type
      expect((shape.title as any)._def.type).toBe('string')
    })

    it('applies descriptions from metadata', async () => {
      const shape = await schema.toMcpInput()
  ...
  describe('toMcpInput — kind mapping', () => {
    ...
    it('converts array to z.array()', async () => {
