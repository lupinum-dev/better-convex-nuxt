...
Use `examples/` when you want maintained public reference apps. Use `examples-next/` when you want to inspect future framework pressure and unfinished example families.
