...
| ------------------------------- | --------------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------------------- |
| Official SDK owns wire behavior | Pass                                    | Pass                                                           | Private exact v2 beta pin; final SDK reconciliation remains      |
...
| Local warm read latency         | 51–60 ms median                         | 10–12 ms median                                                | Two 20-call runs; loopback only, no production conclusion        |
